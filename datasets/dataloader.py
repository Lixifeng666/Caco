...
from Add_Graph_Features import add_graph_features
def loader(args):
    ...
    add_features = add_graph_features(g, features)
    add_in_feats = add_features.shape[1]



    datadict={'g':g,'g_cnn':g_cnn,'features':features,'add_features':add_features,'labels':labels,'train_mask':train_mask,
        'val_mask':val_mask,'test_mask': test_mask,'add_input_dim':add_in_feats,'input_dim':in_feats,'n_classes':n_classes,'n_edges':n_edges,
              'num_node':n_nodes}
